...
SERVICES = [
    {"name": "C1 Monitoring", "path": "monitoring-service-v2", "port": 8011},
    {"name": "C2 Visual",     "path": "visual-service-v2",     "port": 8014},
    {"name": "C3 Content",    "path": "content-service-v2",    "port": 8012},
    {"name": "C4 Intervention", "path": "intervention-service-v2", "port": 8013},
]
