...
3. SERIALIZES the agent state to models/c2_linucb_agent_warmstart.pkl
   so visual-service-v2 loads warm parameters instead of cold identity matrices.
...
# ── Import LinUCB from visual-service-v2 ─────────────────────────────────
...
linucb_mod = _import("linucb", BASE / "visual-service-v2" / "core" / "linucb.py")
...
ARM_PRESETS_PATH = str(BASE / "visual-service-v2" / "data" / "arm_presets.json")
