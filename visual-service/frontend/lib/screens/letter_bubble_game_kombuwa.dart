...
import 'word_start_letter_game_kombuwa.dart';
...
class LetterBubbleGameKombuwa extends StatefulWidget {
  const LetterBubbleGameKombuwa({super.key});

  @override
  State<LetterBubbleGameKombuwa> createState() => _LetterBubbleGameKombuwaState();
}

class _LetterBubbleGameKombuwaState extends State<LetterBubbleGameKombuwa> with SingleTickerProviderStateMixin {
  final String studentId = "student_001";
  final List<String> targetLetters = ["කෙ", "මෙ", "ගෙ", "සෙ", "ලෙ", "බෙ", "තෙ", "දෙ"];
    ...
    try {
      await http.post(
        ...
        body: jsonEncode({
          ...
          "task_id": "letter_bubble_game_kombuwa_01",
  ...
  Future<void> _updateMastery(bool correct) async {
    ...
    try {
      await http.post(
        ...
        body: jsonEncode({
          "student_id": studentId,
          "skill_id": "kombuwa_recognition_bubbles",
          "is_correct": correct,
  ...
  void _launchFireworks() {
    ...
    Future.delayed(const Duration(seconds: 4), () {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (_) => const WordStartLetterGameKombuwa()),
      );
    });
  }
          ...
          child: AlertDialog(
            ...
            content: Column(
              ...
              children: [
                ...
                const SizedBox(height: 10),
                const Text(
                  "ඔබ සාර්ථකව කොම්බුව සහිත අකුරු හඳුනා ගත්තා!", // You successfully identified the letters with Kombuwa!
