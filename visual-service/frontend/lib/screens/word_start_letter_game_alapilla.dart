...
class WordStartLetterGameAlapilla extends StatefulWidget {
  const WordStartLetterGameAlapilla({super.key});

  @override
  State<WordStartLetterGameAlapilla> createState() => _WordStartLetterGameAlapillaState();
}

class _WordStartLetterGameAlapillaState extends State<WordStartLetterGameAlapilla> with TickerProviderStateMixin {
  ...
  final List<WordQuestion> _questions = [
    WordQuestion(
      word: 'පාට',
      missingFirstLetterText: '_ ට',
      correctLetter: 'පා',
      options: ['මා', 'පා', 'ගා', 'තා'],
      imagePath: 'assets/thumbnails/color.jpg',
    ),
    WordQuestion(
      word: 'හාවා',
      missingFirstLetterText: '_ වා',
      correctLetter: 'හා',
      options: ['හා', 'ගා', 'ලා', 'මා'],
      imagePath: 'assets/thumbnails/rabit.jpg',
    ),
    WordQuestion(
      word: 'මාමා',
      missingFirstLetterText: '_ මා',
      correctLetter: 'මා',
      options: ['තා', 'සා', 'මා', 'බා'],
      imagePath: 'assets/thumbnails/uncle.jpg',
    ),
  ];
  ...
  Future<void> _sendTelemetry(String eventType, Map<String, dynamic> additionalData) async {
    ...
    final payload = {
      'game': 'WordStartLetterGameAlapilla',
