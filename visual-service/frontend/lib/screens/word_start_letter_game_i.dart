...
class WordStartLetterGameI extends StatefulWidget {
  const WordStartLetterGameI({super.key});

  @override
  State<WordStartLetterGameI> createState() => _WordStartLetterGameIState();
}

class _WordStartLetterGameIState extends State<WordStartLetterGameI> with TickerProviderStateMixin {
  ...
  final List<WordQuestion> _questions = [
    WordQuestion(
      word: 'ඉර',
      missingFirstLetterText: '_ ර',
      correctLetter: 'ඉ',
      options: ['අ', 'ඉ', 'ඔ', 'එ'],
      imagePath: 'assets/thumbnails/sun.jpg',
    ),
    WordQuestion(
      word: 'ඉබ්බා',
      missingFirstLetterText: '_ බ්බා',
      correctLetter: 'ඉ',
      options: ['ඉ', 'අ', 'එ', 'ඔ'],
      imagePath: 'assets/thumbnails/turtule.jpg',
    ),
    WordQuestion(
      word: 'ඉදල',
      missingFirstLetterText: '_ දල',
      correctLetter: 'ඉ',
      options: ['ඔ', 'එ', 'ඉ', 'අ'],
      imagePath: 'assets/thumbnails/broom.jpg',
    ),
  ];
