...
class WordStartLetterGameKa extends StatefulWidget {
  const WordStartLetterGameKa({super.key});

  @override
  State<WordStartLetterGameKa> createState() => _WordStartLetterGameKaState();
}

class _WordStartLetterGameKaState extends State<WordStartLetterGameKa> with TickerProviderStateMixin {
  ...
  final List<WordQuestion> _questions = [
    WordQuestion(
      word: 'කපුටා',
      missingFirstLetterText: '_ පුටා',
      correctLetter: 'ක',
      options: ['ග', 'ක', 'ම', 'ර'],
      imagePath: 'assets/thumbnails/crow.jpg',
    ),
    WordQuestion(
      word: 'කතුර',
      ...
      correctLetter: 'ක',
      options: ['ක', 'ග', 'ර', 'ම'],
      imagePath: 'assets/thumbnails/sissor.jpg',
    ),
    WordQuestion(
      word: 'කකුල',
      missingFirstLetterText: '_ කුල',
      correctLetter: 'ක',
      options: ['ම', 'ර', 'ක', 'ග'],
      imagePath: 'assets/thumbnails/leg.jpg',
    ),
  ];
