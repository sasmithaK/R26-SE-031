...
class WordStartLetterGameKombuwa extends StatefulWidget {
  const WordStartLetterGameKombuwa({super.key});

  @override
  State<WordStartLetterGameKombuwa> createState() => _WordStartLetterGameKombuwaState();
}

class _WordStartLetterGameKombuwaState extends State<WordStartLetterGameKombuwa> with TickerProviderStateMixin {
  ...
  final List<WordQuestion> _questions = [
    WordQuestion(
      word: 'දෙක',
      missingFirstLetterText: '_ ක',
      correctLetter: 'දෙ',
      options: ['මෙ', 'දෙ', 'ගෙ', 'තෙ'],
      imagePath: 'assets/thumbnails/two.jpg',
    ),
    WordQuestion(
      word: 'ගෙදර',
      missingFirstLetterText: '_ දර',
      correctLetter: 'ගෙ',
      options: ['හෙ', 'ගෙ', 'ලෙ', 'මෙ'],
      imagePath: 'assets/thumbnails/house.jpg',
    ),
    WordQuestion(
      word: 'තෙල්',
      missingFirstLetterText: '_ ල්',
      correctLetter: 'තෙ',
      options: ['තෙ', 'සෙ', 'මෙ', 'බෙ'],
      imagePath: 'assets/thumbnails/oil.jpg',
    ),
  ];
  ...
  Future<void> _sendTelemetry(String eventType, Map<String, dynamic> additionalData) async {
    ...
    final payload = {
      'game': 'WordStartLetterGameKombuwa',
