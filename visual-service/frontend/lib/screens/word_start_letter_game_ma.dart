...
class WordStartLetterGameMa extends StatefulWidget {
  const WordStartLetterGameMa({super.key});

  @override
  State<WordStartLetterGameMa> createState() => _WordStartLetterGameMaState();
}

class _WordStartLetterGameMaState extends State<WordStartLetterGameMa> with TickerProviderStateMixin {
  ...
  final List<WordQuestion> _questions = [
    WordQuestion(
      ...
      correctLetter: 'ම',
      options: ['ක', 'ග', 'ම', 'ර'],
      imagePath: 'assets/thumbnails/flower.jpg',
    ),
    WordQuestion(
      word: 'මහත',
      missingFirstLetterText: '_ හත',
      correctLetter: 'ම',
      options: ['ග', 'ක', 'ර', 'ම'],
      imagePath: 'assets/thumbnails/fat.jpg',
    ),
    WordQuestion(
      word: 'මල්ලි',
      missingFirstLetterText: '_ ල්ලි',
      correctLetter: 'ම',
      options: ['ම', 'ර', 'ක', 'ග'],
      imagePath: 'assets/thumbnails/brother.jpg',
    ),
  ];
