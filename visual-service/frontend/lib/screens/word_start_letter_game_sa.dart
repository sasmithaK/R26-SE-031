...
class WordStartLetterGameSa extends StatefulWidget {
  const WordStartLetterGameSa({super.key});

  @override
  State<WordStartLetterGameSa> createState() => _WordStartLetterGameSaState();
}

class _WordStartLetterGameSaState extends State<WordStartLetterGameSa> with TickerProviderStateMixin {
  ...
  final List<WordQuestion> _questions = [
    WordQuestion(
      word: 'සබන්',
      missingFirstLetterText: '_ බන්',
      correctLetter: 'ස',
      options: ['ල', 'ස', 'ම', 'ග'],
      imagePath: 'assets/thumbnails/soap.jpg',
    ),
    WordQuestion(
      word: 'සවල',
      missingFirstLetterText: '_ වල',
      correctLetter: 'ස',
      options: ['ම', 'ල', 'ස', 'ග'],
      imagePath: 'assets/thumbnails/Shovel.jpg',
    ),
    WordQuestion(
      word: 'සරම',
      missingFirstLetterText: '_ රම',
      correctLetter: 'ස',
      options: ['ස', 'ල', 'ම', 'ග'],
      imagePath: 'assets/thumbnails/saron.jpg',
    ),
  ];
