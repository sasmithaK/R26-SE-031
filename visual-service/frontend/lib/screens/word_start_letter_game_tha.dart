...
class WordStartLetterGameTha extends StatefulWidget {
  const WordStartLetterGameTha({super.key});

  @override
  State<WordStartLetterGameTha> createState() => _WordStartLetterGameThaState();
}

class _WordStartLetterGameThaState extends State<WordStartLetterGameTha> with TickerProviderStateMixin {
  ...
  final List<WordQuestion> _questions = [
    WordQuestion(
      word: 'තරුව',
      missingFirstLetterText: '_ රුව',
      correctLetter: 'ත',
      options: ['ම', 'ග', 'ත', 'ර'],
      imagePath: 'assets/thumbnails/star.jpg',
    ),
    WordQuestion(
      word: 'තල්මසා',
      missingFirstLetterText: '_ ල්මසා',
      correctLetter: 'ත',
      options: ['ග', 'ම', 'ර', 'ත'],
      imagePath: 'assets/thumbnails/whale.jpg',
    ),
    WordQuestion(
      word: 'තක්කාලි',
      missingFirstLetterText: '_ ක්කාලි',
      correctLetter: 'ත',
      options: ['ත', 'ර', 'ම', 'ග'],
      imagePath: 'assets/thumbnails/tomato.jpg',
    ),
  ];
