...
class WordStartLetterGameU extends StatefulWidget {
  const WordStartLetterGameU({super.key});

  @override
  State<WordStartLetterGameU> createState() => _WordStartLetterGameUState();
}

class _WordStartLetterGameUState extends State<WordStartLetterGameU> with TickerProviderStateMixin {
  ...
  final List<WordQuestion> _questions = [
    WordQuestion(
      word: 'උමග',
      missingFirstLetterText: '_ මග',
      correctLetter: 'උ',
      options: ['අ', 'ඉ', 'උ', 'එ'],
      imagePath: 'assets/thumbnails/tunnel.jpg',
    ),
    WordQuestion(
      word: 'උගුර',
      missingFirstLetterText: '_ ගුර',
      correctLetter: 'උ',
      options: ['එ', 'ඔ', 'අ', 'උ'],
      imagePath: 'assets/thumbnails/throt.jpg',
    ),
    WordQuestion(
      word: 'උදෑසන',
      missingFirstLetterText: '_ දෑසන',
      correctLetter: 'උ',
      options: ['උ', 'ආ', 'ඉ', 'එ'],
      imagePath: 'assets/thumbnails/morning.jpg',
    ),
  ];
